...
} from '/flightverse/scene-object-collision.js?v=331';
import { createDrone, STEP } from '/flightverse/runtime.js?v=331';
import { createWeapons } from '/flightverse/weapons.js?v=331';
import { WEAPON_PROFILES } from '/flightverse/weapon-registry.js?v=331';
import { createWeaponModelLibrary } from '/flightverse/weapon-models.js?v=331';
import { radialDamage } from '/flightverse/weapon-effects.js?v=331';
...
async function run() {
  const { resolveCameraCollision } = await import('/flightverse/runtime.js?v=331');
  ...
  const { resolveAimRay } = await import('/flightverse/aiming.js?v=331');
