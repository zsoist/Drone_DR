...
} from '/flightverse/scene-object-collision.js?v=334';
import { createDrone, STEP } from '/flightverse/runtime.js?v=334';
import { createWeapons } from '/flightverse/weapons.js?v=334';
import { WEAPON_PROFILES } from '/flightverse/weapon-registry.js?v=334';
import { createWeaponModelLibrary } from '/flightverse/weapon-models.js?v=334';
import { radialDamage } from '/flightverse/weapon-effects.js?v=334';
...
async function run() {
  const { resolveCameraCollision } = await import('/flightverse/runtime.js?v=334');
  ...
  const { resolveAimRay } = await import('/flightverse/aiming.js?v=334');
