...
import { createDrone, STEP } from '/flightverse/runtime.js?v=307';
import { createWeapons } from '/flightverse/weapons.js?v=307';
...
async function run() {
  const { resolveCameraCollision } = await import('/flightverse/runtime.js?v=307');
  ...
  const { resolveAimRay } = await import('/flightverse/aiming.js?v=307');
