...
import { createDrone, STEP } from '/flightverse/runtime.js?v=303';
import { createWeapons } from '/flightverse/weapons.js?v=303';
...
async function run() {
  const { resolveCameraCollision } = await import('/flightverse/runtime.js?v=303');
  ...
  const { resolveAimRay } = await import('/flightverse/aiming.js?v=303');
