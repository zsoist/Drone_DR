...
import { createDrone, STEP } from '/flightverse/runtime.js?v=306';
import { createWeapons } from '/flightverse/weapons.js?v=306';
...
async function run() {
  const { resolveCameraCollision } = await import('/flightverse/runtime.js?v=306');
  ...
  const { resolveAimRay } = await import('/flightverse/aiming.js?v=306');
