...
} from '/flightverse/scene-object-collision.js?v=339';
import { createDrone, STEP } from '/flightverse/runtime.js?v=339';
import { createWeapons } from '/flightverse/weapons.js?v=339';
import { WEAPON_PROFILES } from '/flightverse/weapon-registry.js?v=339';
import { createWeaponModelLibrary } from '/flightverse/weapon-models.js?v=339';
import { radialDamage } from '/flightverse/weapon-effects.js?v=339';
...
async function run() {
  const { resolveCameraCollision } = await import('/flightverse/runtime.js?v=339');
  ...
  const { resolveAimRay } = await import('/flightverse/aiming.js?v=339');
