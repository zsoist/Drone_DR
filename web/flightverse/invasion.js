...
async function preloadEnemyGlb(type, v) {
  try {
    ...
    if (!SkelUtils) SkelUtils = await import('/vendor/three-addons180/utils/SkeletonUtils.js?v=218');
    const g = await new GLTFLoader().loadAsync(`/assets/enemies/${type}.glb?v=218`);
