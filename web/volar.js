...
} from '/flightverse/scene.js?v=333';
import {
  createLoop, createInput, createDrone, resolveCameraCollision, MODES, RIGS, STEP,
} from '/flightverse/runtime.js?v=333';
import { createGateRush, bestTime } from '/flightverse/gaterush.js?v=333';
import { createRecorder } from '/flightverse/recorder.js?v=333';
import { createAudio } from '/flightverse/audio.js?v=333';
import { makeDraggablePanel } from '/flightverse/panels.js?v=333';
import { createOverlayCoordinator, createTouchSticks } from '/flightverse/touch.js?v=333';
import {
  createFirePointerBindings, createWeaponPicker, installFlightSurfaceGuards,
} from '/flightverse/mobile-command.js?v=333';
import { createSky } from '/flightverse/sky.js?v=333';
import { loadSceneObjects } from '/flightverse/objects.js?v=333';
import { createWeapons, ARSENAL } from '/flightverse/weapons.js?v=333';
import { resolveAimRay } from '/flightverse/aiming.js?v=333';
import {
  WEAPON_PROFILES,
  isContinuousWeaponKey,
} from '/flightverse/weapon-registry.js?v=333';
import { createWeaponModelLibrary } from '/flightverse/weapon-models.js?v=333';
import { createInvasion, ENEMIES } from '/flightverse/invasion.js?v=333';
import { createWorldCollision } from '/flightverse/world-collision.js?v=333';
import { createRenderQualityGovernor } from '/flightverse/render-quality.js?v=333';
import { deriveDroneEnvelope } from '/flightverse/drone-envelope.js?v=333';
import { createLazyLayerLoader, markLoadStep } from '/flightverse/layer-load-state.js?v=333';
import { createCameraRigController } from '/flightverse/camera-rigs.js?v=333';
import { createFlightTools } from '/flightverse/flight-tools.js?v=333';
import { createMutableCollisionWorld } from '/flightverse/scene-object-collision.js?v=333';
import CameraControls from '/vendor/camera-controls.module.js?v=333';
import { canExport, exportDeterministic } from '/flightverse/export.js?v=333';
...
} from '/vendor/postprocessing180.module.js?v=333';
...
async function main() {
  ...
  fetch('/assets/manifest.json?v=333', { cache: 'no-store' }).then(r => r.json()).then(async am => {
    if (!am.drone_glb) return;
    const { GLTFLoader } = await import('/vendor/three-addons180/loaders/GLTFLoader.js?v=333');
