...
import * as THREE from '/flightverse/three.js?v=199';
import { loadManifest, loadTerrain, loadTrack, attachSplat, attachVisualMesh } from '/flightverse/scene.js?v=199';
import { createLoop, createInput, createDrone, MODES, RIGS, STEP } from '/flightverse/runtime.js?v=199';
import { createGateRush, bestTime } from '/flightverse/gaterush.js?v=199';
import { createRecorder } from '/flightverse/recorder.js?v=199';
import { createAudio } from '/flightverse/audio.js?v=199';
import { makeDraggablePanel } from '/flightverse/panels.js?v=199';
import { createTouchSticks } from '/flightverse/touch.js?v=199';
import { createSky } from '/flightverse/sky.js?v=199';
import { loadSceneObjects } from '/flightverse/objects.js?v=199';
import { createWeapons, ARSENAL } from '/flightverse/weapons.js?v=199';
import { createInvasion, ENEMIES } from '/flightverse/invasion.js?v=199';
import CameraControls from '/vendor/camera-controls.module.js?v=199';
import { canExport, exportDeterministic } from '/flightverse/export.js?v=199';
...
} from '/vendor/postprocessing180.module.js?v=199';
...
import { computeBoundsTree, disposeBoundsTree } from '/vendor/three-mesh-bvh180.module.js?v=199';
...
async function main() {
  ...
  fetch('/assets/manifest.json?v=199', { cache: 'no-store' }).then(r => r.json()).then(async am => {
    if (!am.drone_glb) return;
    const { GLTFLoader } = await import('/vendor/three-addons180/loaders/GLTFLoader.js?v=199');
