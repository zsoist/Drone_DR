...
} from '/flightverse/scene.js?v=334';
import {
  createLoop, createInput, createDrone, resolveCameraCollision, MODES, RIGS, STEP,
} from '/flightverse/runtime.js?v=334';
import { createGateRush, bestTime } from '/flightverse/gaterush.js?v=334';
import { createRecorder } from '/flightverse/recorder.js?v=334';
import { createAudio } from '/flightverse/audio.js?v=334';
import { makeDraggablePanel } from '/flightverse/panels.js?v=334';
import { createOverlayCoordinator, createTouchSticks } from '/flightverse/touch.js?v=334';
import {
  createFirePointerBindings, createWeaponPicker, installFlightSurfaceGuards,
} from '/flightverse/mobile-command.js?v=334';
import { createSky } from '/flightverse/sky.js?v=334';
import { loadSceneObjects } from '/flightverse/objects.js?v=334';
import { createWeapons, ARSENAL } from '/flightverse/weapons.js?v=334';
import { resolveAimRay } from '/flightverse/aiming.js?v=334';
import {
  WEAPON_PROFILES,
  isContinuousWeaponKey,
} from '/flightverse/weapon-registry.js?v=334';
import { createWeaponModelLibrary } from '/flightverse/weapon-models.js?v=334';
import { createInvasion, ENEMIES } from '/flightverse/invasion.js?v=334';
import { createWorldCollision } from '/flightverse/world-collision.js?v=334';
import { createRenderQualityGovernor } from '/flightverse/render-quality.js?v=334';
import { deriveDroneEnvelope } from '/flightverse/drone-envelope.js?v=334';
import { createLazyLayerLoader, markLoadStep } from '/flightverse/layer-load-state.js?v=334';
import { createCameraRigController } from '/flightverse/camera-rigs.js?v=334';
import { createFlightTools } from '/flightverse/flight-tools.js?v=334';
import { createMutableCollisionWorld } from '/flightverse/scene-object-collision.js?v=334';
import CameraControls from '/vendor/camera-controls.module.js?v=334';
import { canExport, exportDeterministic } from '/flightverse/export.js?v=334';
...
} from '/vendor/postprocessing180.module.js?v=334';
...
async function main() {
  ...
  fetch('/assets/manifest.json?v=334', { cache: 'no-store' }).then(r => r.json()).then(async am => {
    if (!am.drone_glb) return;
    const { GLTFLoader } = await import('/vendor/three-addons180/loaders/GLTFLoader.js?v=334');
  ...
  const { GLTFLoader: ArsenalGLTFLoader } = await import(
    '/vendor/three-addons180/loaders/GLTFLoader.js?v=334'
  );
