...
import * as THREE from '/flightverse/three.js?v=293';
import {
  loadManifest, loadTerrain, loadTrack, attachSplat, attachVisualMesh, createSceneGeneration,
} from '/flightverse/scene.js?v=293';
import {
  createLoop, createInput, createDrone, resolveCameraCollision, MODES, RIGS, STEP,
} from '/flightverse/runtime.js?v=293';
import { createGateRush, bestTime } from '/flightverse/gaterush.js?v=293';
import { createRecorder } from '/flightverse/recorder.js?v=293';
import { createAudio } from '/flightverse/audio.js?v=293';
import { makeDraggablePanel } from '/flightverse/panels.js?v=293';
import { createTouchSticks } from '/flightverse/touch.js?v=293';
import { createSky } from '/flightverse/sky.js?v=293';
import { loadSceneObjects } from '/flightverse/objects.js?v=293';
import { createWeapons, ARSENAL } from '/flightverse/weapons.js?v=293';
import { createInvasion, ENEMIES } from '/flightverse/invasion.js?v=293';
import { createWorldCollision } from '/flightverse/world-collision.js?v=293';
import { createRenderQualityGovernor } from '/flightverse/render-quality.js?v=293';
import { deriveDroneEnvelope } from '/flightverse/drone-envelope.js?v=293';
import { createLazyLayerLoader, markLoadStep } from '/flightverse/layer-load-state.js?v=293';
import CameraControls from '/vendor/camera-controls.module.js?v=293';
import { canExport, exportDeterministic } from '/flightverse/export.js?v=293';
...
} from '/vendor/postprocessing180.module.js?v=293';
...
async function main() {
  ...
  fetch('/assets/manifest.json?v=293', { cache: 'no-store' }).then(r => r.json()).then(async am => {
    if (!am.drone_glb) return;
    const { GLTFLoader } = await import('/vendor/three-addons180/loaders/GLTFLoader.js?v=293');
