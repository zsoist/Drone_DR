...
import { loadManifest, loadTerrain, loadTrack, attachSplat, attachVisualMesh } from '/flightverse/scene.js?v=173';
import { createLoop, createInput, createDrone, MODES, RIGS, STEP } from '/flightverse/runtime.js?v=173';
import { createGateRush, bestTime } from '/flightverse/gaterush.js?v=173';
import { createRecorder } from '/flightverse/recorder.js?v=173';
import { createAudio } from '/flightverse/audio.js?v=173';
import { makeDraggablePanel } from '/flightverse/panels.js?v=173';
import { createTouchSticks } from '/flightverse/touch.js?v=173';
import { createSky } from '/flightverse/sky.js?v=173';
import { loadSceneObjects } from '/flightverse/objects.js?v=173';
import { createWeapons, ARSENAL } from '/flightverse/weapons.js?v=173';
import { createInvasion, ENEMIES } from '/flightverse/invasion.js?v=173';
import CameraControls from '/vendor/camera-controls.module.js?v=173';
import { canExport, exportDeterministic } from '/flightverse/export.js?v=173';
...
} from '/vendor/postprocessing180.module.js?v=173';
...
import { computeBoundsTree, disposeBoundsTree } from '/vendor/three-mesh-bvh180.module.js?v=173';
...
async function main() {
  ...
  fetch('/assets/manifest.json?v=173', { cache: 'no-store' }).then(r => r.json()).then(async am => {
    if (!am.drone_glb) return;
    const { GLTFLoader } = await import('/vendor/three-addons180/loaders/GLTFLoader.js?v=173');
