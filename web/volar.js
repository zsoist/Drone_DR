...
} from '/flightverse/scene.js?v=339';
import {
  createLoop, createInput, createDrone, resolveCameraCollision, MODES, RIGS, STEP,
} from '/flightverse/runtime.js?v=339';
import { createGateRush, bestTime } from '/flightverse/gaterush.js?v=339';
import { createRecorder } from '/flightverse/recorder.js?v=339';
import { createAudio } from '/flightverse/audio.js?v=339';
import { makeDraggablePanel } from '/flightverse/panels.js?v=339';
import { createOverlayCoordinator, createTouchSticks } from '/flightverse/touch.js?v=339';
import {
  createFirePointerBindings, createWeaponPicker, installFlightSurfaceGuards,
} from '/flightverse/mobile-command.js?v=339';
import { createSky } from '/flightverse/sky.js?v=339';
import { loadSceneObjects } from '/flightverse/objects.js?v=339';
import { createWeapons, ARSENAL } from '/flightverse/weapons.js?v=339';
import { resolveAimRay } from '/flightverse/aiming.js?v=339';
import {
  WEAPON_PROFILES,
  isContinuousWeaponKey,
} from '/flightverse/weapon-registry.js?v=339';
import { createWeaponModelLibrary } from '/flightverse/weapon-models.js?v=339';
import { createInvasion, ENEMIES } from '/flightverse/invasion.js?v=339';
import { createWorldCollision } from '/flightverse/world-collision.js?v=339';
import { createRenderQualityGovernor } from '/flightverse/render-quality.js?v=339';
import { deriveDroneEnvelope } from '/flightverse/drone-envelope.js?v=339';
import { createLazyLayerLoader, markLoadStep } from '/flightverse/layer-load-state.js?v=339';
import { createCameraRigController } from '/flightverse/camera-rigs.js?v=339';
import { createFlightTools } from '/flightverse/flight-tools.js?v=339';
import { createMutableCollisionWorld } from '/flightverse/scene-object-collision.js?v=339';
import CameraControls from '/vendor/camera-controls.module.js?v=339';
import { canExport, exportDeterministic } from '/flightverse/export.js?v=339';
...
} from '/vendor/postprocessing180.module.js?v=339';
...
async function main() {
  ...
  fetch('/assets/manifest.json?v=339', { cache: 'no-store' }).then(r => r.json()).then(async am => {
  ...
  const { GLTFLoader: ArsenalGLTFLoader } = await import(
    '/vendor/three-addons180/loaders/GLTFLoader.js?v=339'
  );
