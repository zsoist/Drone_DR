...
import * as THREE from '/flightverse/three.js?v=196';
import { loadManifest, loadTerrain, loadTrack, attachSplat, attachVisualMesh } from '/flightverse/scene.js?v=196';
import { createLoop, createInput, createDrone, MODES, RIGS, STEP } from '/flightverse/runtime.js?v=196';
import { createGateRush, bestTime } from '/flightverse/gaterush.js?v=196';
import { createRecorder } from '/flightverse/recorder.js?v=196';
import { createAudio } from '/flightverse/audio.js?v=196';
import { makeDraggablePanel } from '/flightverse/panels.js?v=196';
import { createTouchSticks } from '/flightverse/touch.js?v=196';
import { createSky } from '/flightverse/sky.js?v=196';
import { loadSceneObjects } from '/flightverse/objects.js?v=196';
import { createWeapons, ARSENAL } from '/flightverse/weapons.js?v=196';
import { createInvasion, ENEMIES } from '/flightverse/invasion.js?v=196';
import CameraControls from '/vendor/camera-controls.module.js?v=196';
import { canExport, exportDeterministic } from '/flightverse/export.js?v=196';
...
} from '/vendor/postprocessing180.module.js?v=196';
...
import { computeBoundsTree, disposeBoundsTree } from '/vendor/three-mesh-bvh180.module.js?v=196';
...
async function main() {
  ...
  fetch('/assets/manifest.json?v=196', { cache: 'no-store' }).then(r => r.json()).then(async am => {
    if (!am.drone_glb) return;
    const { GLTFLoader } = await import('/vendor/three-addons180/loaders/GLTFLoader.js?v=196');
