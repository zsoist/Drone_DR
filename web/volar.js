...
} from '/flightverse/scene.js?v=300';
import {
  createLoop, createInput, createDrone, resolveCameraCollision, MODES, RIGS, STEP,
} from '/flightverse/runtime.js?v=300';
import { createGateRush, bestTime } from '/flightverse/gaterush.js?v=300';
import { createRecorder } from '/flightverse/recorder.js?v=300';
import { createAudio } from '/flightverse/audio.js?v=300';
import { makeDraggablePanel } from '/flightverse/panels.js?v=300';
import { createTouchSticks } from '/flightverse/touch.js?v=300';
import { createSky } from '/flightverse/sky.js?v=300';
import { loadSceneObjects } from '/flightverse/objects.js?v=300';
import { createWeapons, ARSENAL } from '/flightverse/weapons.js?v=300';
import { isContinuousWeapon, resolveAimRay } from '/flightverse/aiming.js?v=300';
import { createInvasion, ENEMIES } from '/flightverse/invasion.js?v=300';
import { createWorldCollision } from '/flightverse/world-collision.js?v=300';
import { createRenderQualityGovernor } from '/flightverse/render-quality.js?v=300';
import { deriveDroneEnvelope } from '/flightverse/drone-envelope.js?v=300';
import { createLazyLayerLoader, markLoadStep } from '/flightverse/layer-load-state.js?v=300';
import CameraControls from '/vendor/camera-controls.module.js?v=300';
import { canExport, exportDeterministic } from '/flightverse/export.js?v=300';
...
} from '/vendor/postprocessing180.module.js?v=300';
...
async function main() {
  ...
  fetch('/assets/manifest.json?v=300', { cache: 'no-store' }).then(r => r.json()).then(async am => {
    if (!am.drone_glb) return;
    const { GLTFLoader } = await import('/vendor/three-addons180/loaders/GLTFLoader.js?v=300');
