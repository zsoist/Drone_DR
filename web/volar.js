...
import * as THREE from '/flightverse/three.js?v=152';
import { loadManifest, loadTerrain, loadTrack, attachSplat, attachVisualMesh } from '/flightverse/scene.js?v=152';
import { createLoop, createInput, createDrone, MODES, RIGS, STEP } from '/flightverse/runtime.js?v=152';
import { createGateRush, bestTime } from '/flightverse/gaterush.js?v=152';
import { createRecorder } from '/flightverse/recorder.js?v=152';
import { createAudio } from '/flightverse/audio.js?v=152';
import { makeDraggablePanel } from '/flightverse/panels.js?v=152';
import { createTouchSticks } from '/flightverse/touch.js?v=152';
import { createSky } from '/flightverse/sky.js?v=152';
import { loadSceneObjects } from '/flightverse/objects.js?v=152';
import { createWeapons, ARSENAL } from '/flightverse/weapons.js?v=152';
import { createInvasion, ENEMIES } from '/flightverse/invasion.js?v=152';
import CameraControls from '/vendor/camera-controls.module.js?v=152';
import { canExport, exportDeterministic } from '/flightverse/export.js?v=152';
...
} from '/vendor/postprocessing180.module.js?v=152';
...
import { computeBoundsTree, disposeBoundsTree } from '/vendor/three-mesh-bvh180.module.js?v=152';
...
async function main() {
  ...
  fetch('/assets/manifest.json?v=152', { cache: 'no-store' }).then(r => r.json()).then(async am => {
    if (!am.drone_glb) return;
    const { GLTFLoader } = await import('/vendor/three-addons180/loaders/GLTFLoader.js?v=152');
