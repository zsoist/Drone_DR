...
import { loadManifest, loadTerrain, loadTrack, attachSplat } from '/flightverse/scene.js?v=116';
import { createLoop, createInput, createDrone, MODES, RIGS, STEP } from '/flightverse/runtime.js?v=116';
import { createGateRush, bestTime } from '/flightverse/gaterush.js?v=116';
import { createRecorder } from '/flightverse/recorder.js?v=116';
import { createAudio } from '/flightverse/audio.js?v=116';
import { createTouchSticks } from '/flightverse/touch.js?v=116';
import { createSky } from '/flightverse/sky.js?v=116';
import { loadSceneObjects } from '/flightverse/objects.js?v=116';
import { createWeapons, ARSENAL } from '/flightverse/weapons.js?v=116';
import { createInvasion, ENEMIES } from '/flightverse/invasion.js?v=116';
import CameraControls from '/vendor/camera-controls.module.js?v=116';
import { canExport, exportDeterministic } from '/flightverse/export.js?v=116';
...
} from '/vendor/postprocessing180.module.js?v=116';
...
import { computeBoundsTree, disposeBoundsTree } from '/vendor/three-mesh-bvh180.module.js?v=116';
...
async function main() {
  ...
  fetch('/assets/manifest.json?v=116', { cache: 'no-store' }).then(r => r.json()).then(async am => {
