...
import * as THREE from '/vendor/three180.module.js?v=65';
import { OrbitControls } from '/vendor/three-addons180/controls/OrbitControls.js?v=65';
...
export async function mountSplatViewer(host, splatUrl, { bytes = 0, onStatus } = {}) {
  const { SparkRenderer, SplatMesh } = await import('/vendor/spark.module.js?v=65');
